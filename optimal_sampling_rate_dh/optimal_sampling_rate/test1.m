...
for j = 1:4
    ...
    for i = 1 : 10
        ps1 = ps(i);
          [x_crlb(iter),xy_crlb(iter),z_crlb(iter),crlb(iter),crlb_at_z(:,:,iter)] = compute_CRLB(data_raw,ps1,parameters); 
        iter = iter + 1;
    end
    if j == 1
        crlbdh_100 = crlb_at_z(:,:,6);       %100nm results
...
save('optimal_sampling_rate\data\dh\crlb_revised.mat',"crlb_revised");
save('optimal_sampling_rate\data\dh\crlb_z_revised.mat',"crlb_z_revised");
save('optimal_sampling_rate\data\dh\crlb_xy_revised.mat',"crlb_xy_revised");
save('optimal_sampling_rate\data\dh\crlbatz.mat',"crlbatz");
save('optimal_sampling_rate\data\dh\crlbdh_100.mat',"crlbdh_100");
draw(parameters,ps,crlbdh_100,crlbatz,crlb_revised,crlb_xy_revised,crlb_z_revised);