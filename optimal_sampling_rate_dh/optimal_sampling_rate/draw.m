function draw(parameters,ps,crlb_100,crlbatz,crlb_revised,crlb_xy_revised,crlb_z_revised)
    %%plot 4pi 100nm crlb at different z-depth
    start = parameters.zemit;
    step = 2*abs(parameters.zemit)/(parameters.Nmol-1);
    stop = -parameters.zemit-step;
    z = start:step:stop;

    figure1 = figure('Color',[1 1 1]);
    axes1 = axes('Parent',figure1);
    hold(axes1,'on');
    plot(z,crlb_100(1,:),'LineWidth',3.5,'Color',[0.247058824,0.168627451,0.42745098]);hold on
    plot(z,crlb_100(2,:),'LineWidth',3.5,'Color',[0.941176471,0.392156863,0.28627451],'LineStyle','-');hold on
    plot(z,crlb_100(3,:),'LineWidth',3.5,'Color',[1,0.666666667,0.196078431]);
    ...
    plot(ps,crlbatz(21,:),'LineWidth',3.5,'Color',[1,0.666666667,0.196078431]); hold on
    plot(ps,crlbatz(41,:),'LineWidth',3.5,'Color',[0.188235294,0.592156863,0.643137255]); hold on
    plot(ps,crlbatz(61,:),'LineWidth',3.5,'Color',[0.019607843,0.31372549,0.356862745]);
    ylim([0 70]);
    xlim([30 250]);
