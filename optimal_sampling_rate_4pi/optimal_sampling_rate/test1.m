%% Generate a PSF 
%CASE 1 4Pi PSF
[parameters] = setting_parameters();  %can't change for 4Pi PSF
psftype = input('Confirm PSF type:');
[data_raw] = psf_generate(psftype);
parameters.ps_max = 250;
parameters.bg = 20;   %background noise
parameters.readout_noise = 2;   %readout noise
ps = [40,48,56,64,72,80,96,104,120,136,176,200,240];
Nphs = [1000,2000,3000,10000];
%% Compute CRLB at different pixel size
iter1 = 1;
for j = 1:4  %photon condition number
...
save('optimal_sampling_rate\data\4pi\crlb_revised.mat',"crlb_revised");
save('optimal_sampling_rate\data\4pi\crlb_z_revised.mat',"crlb_z_revised");
save('optimal_sampling_rate\data\4pi\crlb_xy_revised.mat',"crlb_xy_revised");
save('optimal_sampling_rate\data\4pi\crlbatz.mat',"crlbatz");
save('optimal_sampling_rate\data\4pi\crlb4pi_100.mat',"crlb4pi_100");
draw(parameters,ps,crlb4pi_100,crlbatz,crlb_revised,crlb_xy_revised,crlb_z_revised);